...
export const PRODUCTS = [
  ...
  },
  {
    ...
    {
      id: "hotchilli",
      name: "Hot Chilli Makhana",
      flavor: "Hot Chilli",
      color: "bg-rose-600",
      textColor: "text-rose-600",
      description: "Extra spicy roasted makhana for those who love intense heat and bold flavors.",
    ...
    {
      id: "manchurian",
      name: "Manchurian Makhana",
      flavor: "Manchurian",
      color: "bg-indigo-600",
      textColor: "text-indigo-600",
      description: "Fusion of Indo-Chinese Manchurian flavors with crispy roasted makhana for a unique taste.",
    ...
    },
    {
      ...
      description: "Authentic tandoori spices blended with roasted makhana for a smoky and rich taste.",
